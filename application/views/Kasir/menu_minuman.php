                        ...
                        <div class="card">
                            <div class="card-body">
								...
								<div class="alert alert-info">
									...
									Selamat Datang Di Menu Minuman Kedai Kopi 11, Silahkan Pilih Minuman Yang Akan Dipesan.
								</div>
                            ...
                            <?php echo form_open('Kasir/Transaksi/add') ?>
					         <div class="row">
					             <div class="col-md-6">
					               <div class="form-group">
					                    <label for="foto">Nama Minuman</label>
					                    <?php echo cmb_dinamis('id_minuman','tbl_minuman','nm_minuman','id_minuman') ?>
					                 </div>
					             </div>
					         </div>
					         ...
					         <div class="row">
					         	 <div class="col-md-6">
					                <div class="form-group">
					                    ...
					                    <?php echo anchor('Kasir/Transaksi/selesai','Selesai',['class'=>'btn btn-info']) ?>
					                 	</div>
					                 </div>
					             </div>
					           </div>
						...
						<table class="table table-bordered">
						      ...
						      <th style="text-align:center;"> Cancel</th>
						       ...
						       <?php $subtotal=$harga ?>
						        ...
						        <td align="center"><?php echo anchor('Kasir/Transaksi/cancel/'.$item->id_psn_minuman,'Cancel',['class'=>'btn btn-danger']) ?></td></tr>
