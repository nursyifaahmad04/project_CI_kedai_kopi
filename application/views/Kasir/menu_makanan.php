                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <?php echo form_open('Kasir/Transaksi2/add') ?>
					         <div class="row">
					             <div class="col-md-6">
					         ...
					         <div class="row">
					         	 <div class="col-md-6">
					                <div class="form-group">
					                    ...
					                    <?php echo anchor('Kasir/Transaksi2/selesai','Selesai',['class'=>'btn btn-info']) ?>
					                 	</div>
					                 </div>
					             </div>
					           </div>
						      ...
						      <th style="text-align:center;"> Cancel</th>
						       ...
						       <?php $subtotal=$harga ?>
						        ...
						        <td align="center"><?php echo anchor('Kasir/Transaksi2/cancel/'.$item->id_psn_makanan,'Cancel',['class'=>'btn btn-danger']) ?></td></tr>
