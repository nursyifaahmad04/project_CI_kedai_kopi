                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <?php echo form_open('Admin/Transaksi/add') ?>
					         <div class="row">
					             <div class="col-md-6">
					         ...
					         <div class="row">
					         	 <div class="col-md-6">
					                <div class="form-group">
					                    ...
					                    <?php echo anchor('Admin/Transaksi/selesai','Selesai',['class'=>'btn btn-info']) ?>
					                 	</div>
					                 </div>
					             </div>
					           </div>
						...
						<table class="table table-bordered">
						      ...
						      <th style="text-align:center;"> Cancel</th>
						       ...
						       <?php $subtotal=$harga ?>
						        ...
						        <td align="center"><?php echo anchor('Admin/Transaksi/cancel/'.$item->id_psn_minuman,'Cancel',['class'=>'btn btn-danger']) ?></td></tr>
