                        ...
                        <div class="card">
                            <div class="card-body">
								...
								<div class="alert alert-info">
									...
									Selamat Datang Di Menu Laporan Penjualan Makanan Kedai Kopi 11.
								</div>

								<a href="<?php echo site_url('Admin/Admin/cetak_laporan_makanan')?>" target="blank" class="btn btn-success">Cetak Laporan</a>
                                <p></p>

                                <table class="table table-bordered">
						         <div class="card-header">
						              <tr class="success">
						            <th colspan="6" style="text-align: center;">Laporan Penjualan Makanan</th>
						              </tr>
						        </div>
						...
						<tr><td colspan="4"><p align="right"><i class="fab fa-wolf-pack-battalion"> Total </i></p></td>
							<td align="right"><?php echo "Rp.".number_format($total).",-" ?></td></tr>
								...
								<table class="table table-bordered">
						         <div class="card-header">
						              <tr class="success">
						            <th colspan="6" style="text-align: center;">Laporan Profit makanan</th>
						              </tr>
						        </div>
						      <th style="text-align:center;">No</th>
						      <th style="text-align:center;">Nama Makanan</th>
