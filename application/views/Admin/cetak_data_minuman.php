...
<font size="5"><center><u>Daftar Minuman</u></center></font>
                                        ...
                                        <table align="center" width="90%" cellspacing="0" cellpadding="0">
                                            <thead>
                                                <tr bgcolor="lightgray">
                                                    ...
                                                    <th style="border-right: 1px solid #000; border-top: 1px solid #000; border-bottom: 1px solid #000; padding: 3px 5px;">Nama Minuman</th>
                                            ...
                                            <tr>
                                                ...
                                                <td  style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: 1px solid #000; border-bottom: 1px solid #000; padding: 3px 5px;"><?php echo $minuman->kd_minuman ?></td>
                                                <td  style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: 1px solid #000; border-bottom: 1px solid #000; padding: 3px 5px;"><?php echo $minuman->nm_minuman ?></td>
                                                <td align="Right"  style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: 1px solid #000; border-bottom: 1px solid #000; padding: 3px 5px;">Rp.<?php echo number_format($minuman->modal,0,',','.')?></td>
                                                <td align="Right"  style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: 1px solid #000; border-bottom: 1px solid #000; padding: 3px 5px;">Rp.<?php echo number_format($minuman->harga_jual,0,',','.')?></td>
                                             <?php } ?>   
                                            </tbody>
                                        </table>
</body>